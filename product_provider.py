...
class ProductProvider:
    ...
    prod_dict_by_id = dict(
        [
            ...
            (13486, Product(13486, "MATCHACCINO (Hot)", 4.3, 7)),
            (13487, Product(13487, "MATCHA LATTE (Hot)", 4.4, 7)),
            ...
            (13493, Product(13493, "ICED LATTE", 4.9, 7)),
            ...
            (13510, Product(13510, "SAN SEBASTIAN CHEESECAKE", 5.9, 7)),
            ...
            (13524, Product(13524, "Dirty Ice Chai Latte", 5.1, 7)),
            ...
            (13529, Product(13529, "BIONADE NATURTRÜB ORANGE", 3.1, 7)),
            ...
            (14275, Product(14275, "Classic Cheesy Cheese - Pan Pizza", 12.9, 7)),
            (14276, Product(14276, "Cheesy Salami - Pan Pizza", 13.9, 7)),
            (14277, Product(14277, "Türken Pan Pizza", 14.3, 7)),
            (14278, Product(14278, "Ocean's Eleven", 14.3, 7)),
            (14279, Product(14279, "Du bist Hippster - Pan Pizza", 13.4, 7)),
            (14280, Product(14280, "Toad - Pan Pizza", 13.2, 7)),
            (14281, Product(14281, "Le Sauce Hollandaise - Pan Pizza", 14.9, 7)),
            (14282, Product(14282, "Korean Style - Pan Pizza", 14.9, 7)),
            ...
            (14996, Product(14996, "Pumpkin Spice Latte", 5, 7)),
            ...
            (15456, Product(15456, "FLAT WHITE (alternative)", 4.2, 19)),
            ...
            (15570, Product(15570, "Frankys Dubai Tiramisu", 8.5, 7)),
            ...
            (15636, Product(15636, "Nasty Parmesan Chicken Box", 14.99, 19)),
            ...
            (15651, Product(15651, "HOT CHOCOLATE [Duplicate20241215152058]", 4.2, 7)),
            (15652, Product(15652, "GOLDEN MILK [Duplicate20241215152115]", 4.2, 7)),
            (15653, Product(15653, "CHAI LATTE [Duplicate20241215152123]", 4.2, 7)),
            (15654, Product(15654, "Lavendel Honig Latte [Duplicate20241215152133]", 4.2, 7)),
            (15655, Product(15655, "Dirty Chai Latte [Duplicate20241215152144]", 4.9, 7)),
            (15656, Product(15656, "Peppermint Mocha [Duplicate20241215152157]", 5.5, 7)),
            (15657, Product(15657, "Dirty Chai Latte [Duplicate20241215152207]", 4.9, 7)),
