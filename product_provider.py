...
class ProductProvider:
    ...
    prod_dict_by_id = dict(
        [
            ...
            (14933, Product(14933, "Frankys Dubai Tiramisu", 8.5, 7)),
            ...
            (15446, Product(15446, "Franky’s Dubai Chocolate Tiramisu", 8.9, 7)),
            ...
            (15449, Product(15449, "ESPRESSI", 2.1, 7)),
            (15450, Product(15450, "Lotus Biscoff Cream Pie", 5.9, 7)),
            (15451, Product(15451, "DOPPIO ESPRESSI", 3.2, 7)),
            (15452, Product(15452, "MILCHKAFFEE", 3.9, 7)),
            (15453, Product(15453, "LATTE MACCHIATO Alternative Milch", 3.8, 19)),
            (15454, Product(15454, "CAPPUCCINO", 3.7, 7)),
            (15455, Product(15455, "LONG BLACK", 3.2, 7)),
            (15456, Product(15456, "FLAT WHITE", 4.2, 7)),
            (15457, Product(15457, "V60 POUR-OVER", 4.9, 7)),
            (15458, Product(15458, "APOTHEKE (300 ml)", 5.1, 7)),
            (15459, Product(15459, "IMMUNSHOT INGWER (100 ml)", 4, 7)),
            (15460, Product(15460, "ORANGENSAFT (300 ml)", 4.4, 7)),
            (15461, Product(15461, "HOT CHOCOLATE", 4.2, 7)),
            (15462, Product(15462, "GOLDEN MILK", 4.2, 7)),
            (15463, Product(15463, "CHAI LATTE", 4.2, 7)),
            (15464, Product(15464, "FRANKO® FLAT", 3.9, 7)),
            (15465, Product(15465, "FRANKO® PRESSO", 3.5, 7)),
            (15466, Product(15466, "ICED LATTE", 4.9, 7)),
            (15467, Product(15467, "ESPRESSO TONIC", 3.5, 7)),
            (15468, Product(15468, "TEE GLASS", 3.8, 7)),
            (15469, Product(15469, "GROSSE KANNE", 5.9, 7)),
            (15470, Product(15470, "TUNESIAN TEA", 5.9, 7)),
            (15471, Product(15471, "AFGHANISCHER", 6.5, 7)),
            ...
            (15477, Product(15477, "ICED MATCHA LATTE", 4.7, 7)),
            (15478, Product(15478, "Selters Sprudel 0,25l", 2.8, 7)),
            (15479, Product(15479, "MATCHACCINO (Hot)", 3.3, 7)),
            (15480, Product(15480, "BIONADE HOLUNDER", 3.1, 7)),
            (15481, Product(15481, "MATCHA LATTE (Hot)", 3.8, 7)),
            ...
            (15493, Product(15493, "Ice Chai Latte", 4.9, 7)),
            (15494, Product(15494, "Dirty Ice Chai Latte", 5.1, 7)),
            (15495, Product(15495, "Limoncello Fresh", 5.2, 7)),
            (15496, Product(15496, "Spanish Iced Latte", 4.9, 7)),
            ...
            (15504, Product(15504, "Ice Coconut Matcha", 5.3, 7)),
            (15505, Product(15505, "Matcha Dose (30g für c.a 20-25 Matcha Getränke)", 19.9, 7)),
            (15506, Product(15506, "CORTADO", 3.2, 7)),
            ...
            (15514, Product(15514, "Cold Brew", 5.2, 7)),
            (15515, Product(15515, "Mille Feuille", 4, 7)),
            (15516, Product(15516, "Iced Long Black", 3.5, 7)),
            ...
            (15528, Product(15528, "Lavander Iced Latte", 5.2, 7)),
            (15529, Product(15529, "Franky's Coffee", 10.9, 7)),
            (15530, Product(15530, "Mango Ice Matcha Latte", 5.7, 7)),
            ...
            (15637, Product(15637, "CAPPUCCINO [Duplicate20241214143436]", 3.7, 7)),
